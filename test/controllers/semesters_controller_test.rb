...
class SemestersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create semester" do
    assert_difference('Semester.count') do
      post semesters_url, params: { semester: { ano: @semester.ano, dataFim: @semester.dataFim, dataInicio: @semester.dataInicio, periodo: @semester.periodo } }
    end
  ...
  test "should update semester" do
    patch semester_url(@semester), params: { semester: { ano: @semester.ano, dataFim: @semester.dataFim, dataInicio: @semester.dataInicio, periodo: @semester.periodo } }

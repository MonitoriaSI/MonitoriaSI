...
class DisciplinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create discipline" do
    assert_difference('Discipline.count') do
      post disciplines_url, params: { discipline: { cargaHoraria: @discipline.cargaHoraria, codigo: @discipline.codigo, descricao: @discipline.descricao, periodo: @discipline.periodo, sigla: @discipline.sigla } }
    end
  ...
  test "should update discipline" do
    patch discipline_url(@discipline), params: { discipline: { cargaHoraria: @discipline.cargaHoraria, codigo: @discipline.codigo, descricao: @discipline.descricao, periodo: @discipline.periodo, sigla: @discipline.sigla } }
